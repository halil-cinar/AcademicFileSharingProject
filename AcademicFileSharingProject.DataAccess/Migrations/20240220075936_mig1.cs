...
namespace AcademicFileSharingProject.DataAccess.Migrations
{
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PostImageId = table.Column<long>(type: "bigint", nullable: false),
                    IsAir = table.Column<bool>(type: "bit", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<long>(type: "bigint", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SubscribeUserID = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscribe_User_SubscribeUserID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogComment_User_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostComment_User_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogComment_SenderUserId",
                table: "BlogComment",
                column: "SenderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComment_SenderUserId",
                table: "PostComment",
                column: "SenderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscribe_SubscribeUserID",
                table: "Subscribe",
        ...
        table: "User",
        columns: new[] { "Name", "Surname", "Email", "Email2", "PhoneNumber", "Title", "Description", "CreatedTime", "IsDeleted" },
        values: new object[,]
        {
            {
                "Admin",
                "Admin",
                "halilcinar1260@gmail.com",
                "halilcinar1260@outlook.com",
                "05516788915",
                "System Admin",
            ...
            migrationBuilder.InsertData(
        table: "Identity",
        columns: new[] { "IsDeleted", "CreatedTime", "IsValid", "UserId", "PasswordSalt", "PasswordHash" },
        values: new object[,]
        {
            {
               ...
               1,
                salt,
                ExtensionsMethods.CalculateMD5Hash(salt + "12345" + salt)
            }
        });
            migrationBuilder.InsertData(
        table: "UserRole",
        columns: new[] { "CreatedTime", "IsDeleted", "Role", "UserId" },
        values: new object[,]
        {
            {
                DateTime.Now,
